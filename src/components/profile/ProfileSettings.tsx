...
import { User, Settings, Shield, LogOut, Save, Edit3, Eye, EyeOff, Camera } from 'lucide-react';
                    ...
                    {!isEditing ? (
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                {profile.email !== demoUsers.find(u => u.id === userId)?.email && (
                                    <p className="text-xs text-muted-foreground mt-1">
                                        Email has been updated from original
                                    </p>
                                )}
                            </div>
                            <Button
